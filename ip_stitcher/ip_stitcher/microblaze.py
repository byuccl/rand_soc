...
class Microblaze(IPrandom):
    ...
    def instance(self):
        ...
        self._bd_str += "# Instruction memory\n"
        ...
        if self.axi_master:
            ...
            ).connect(f"{instance_name}/M_AXI_DP")
        ...
        self._create_hier_pin("clk", "clk", "I", 1).connect(
            (
                f"{instance_name}/Clk",
        ...
        ).connect(f"{instance_name}/INTERRUPT")
