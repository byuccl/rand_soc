...
class IP:
    ...
    def instance(self):
        ...
        self._bd_str += f"create_bd_cell -type hier {self.hier_name}\n"
    ...
    def _new_instance(self, ip_name, instance_name, properties=None):
        ...
        self._bd_str += f"move_bd_cells [get_bd_cells {self.hier_name}] [get_bd_cells {instance_name}]\n"
        if properties:
    ...
    def _set_instance_properties(self, instance_name, properties):
        ...
        for key, value in properties.items():
            prop += f"{key} {value} "
        self._bd_str += f'set_property -dict "{prop}" [get_bd_cells {self.hier_name}/{instance_name}]\n'
    ...
    def _connect_instance_pin(self, instance_pin_a, instance_pin_b):
        self._bd_str += f"connect_bd_intf_net [get_bd_intf_pins {self.hier_name}/{instance_pin_a}] [get_bd_intf_pins {self.hier_name}/{instance_pin_b}]\n"

    def _assign_bd_address(self, instance_addr_space_name, slave_name):
        self._bd_str += f"assign_bd_address -target_address_space /{self.hier_name}/{instance_addr_space_name} [get_bd_addr_segs {self.hier_name}/{slave_name}] -force\n"
